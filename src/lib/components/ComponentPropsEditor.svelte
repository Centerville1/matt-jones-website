...
<div class="props-editor">
  ...
  <div class="context-section">
    <label for="contextId">
      ...
      <span class="prop-description">
        Components with the same Link ID can share data. Leave empty if this
        component doesn't need to connect to others.
      </span>
    </label>
    <input
      id="contextId"
      ...
      <div class="form-group">
        ...
        {#if propDef.type === 'number'}
          <input
            ...
            step={propDef.step}
            on:input={(e) =>
              updateProp(propName, parseFloat(e.currentTarget.value))}
          />
  ...
  <div class="dialog-actions">
    ...
    <button on:click={onCancel} type="button" class="button-secondary">
      Cancel
    </button>
  </div>
</div>
